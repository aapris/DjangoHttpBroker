"""
Django settings for httpbroker project.
...
SECRET_KEY = 'f-dt2m%$k5@dyx_wy(fjjy)s@g5^h%ykv+!qr8^2q3cork5i2t'
...
WSGI_APPLICATION = 'httpbroker.wsgi.application'
...
# CELERY
CELERY_BROKER_URL = 'amqp://localhost'  # RabbitMQ on localhost
...
try:
    ...
    print(f"cp {BASE_DIR}/local_settings-example.py {BASE_DIR}/local_settings.py")
